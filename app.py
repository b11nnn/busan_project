...
# 페이지 기본 설정
st.set_page_config(page_title="부울경 워라밸 나침반", page_icon="🧭", layout="wide")

# 타이틀 및 소개
st.title("🧭 부울경 커리어 & 라이프 나침반")
st.markdown("수도권이 아니어도 괜찮아! 당신의 전공, 성향에 맞춘 부울경 알짜 기업과 정착 시뮬레이션을 제공합니다.")
...
# --------------------------------------------------------------------------------
    ...
    st.markdown("첨부해주신 **고용24 API(채용정보, 기업정보)**를 연동하여 결과가 표시되는 영역입니다.")
